                                    ...
                                    <c:forEach var="item" items="${carousel}" varStatus="loop">
                                        ...
                                        <article class="item promote<c:if test="${loop.index == 0}"> active</c:if>">
                                            ...
                                            <div class="promote-body imaged">
                                                ...
                                                <p><a href="controller?section=product&id=${item.id}" class="btn btn-primary"><i class="fa fa-eye fa-lg"></i>&nbsp;&nbsp;Détail</a>&nbsp;<a href="${currentURL}&mode=cart&id=${item.id}" class="btn btn-default"><i class="fa fa-cart-plus fa-lg"></i>&nbsp;&nbsp;Ajouter</a></p>
                                            </div>
                                        </article>
                                        ...
                                        <article class="featured">
                                            <div class="featured-media">
                                                ...
                                                <ul class="featured-actions text-center list-inline">
                                                    ...
                                                    <li><a href="${currentURL}&mode=cart&id=${item.id}" title="Ajouter au panier"><i class="fa fa-cart-plus"></i></a></li>
                                                </ul>
                                            </div>
